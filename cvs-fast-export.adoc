...
prevents corruption of bimary content.
...
http://www.catb.org/~esr/cvs-fast-export/reporting-bugs.html[Reporting
bugs in cvs-fast-export] before shipping a report. The project page
itself is at http://catb.org/~esr/cvs-fast-export
