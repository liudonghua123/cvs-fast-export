...
--reposurgeon::
Ship a sourcety[e header comment for reposurgeom to use, declaring
"cvs" if a CVSROOT file has been seen and RCS otherwise.  Emit for
each commit a list of the CVS file:revision pairs composing it as a
